...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        //Lot
        'lot_id' => 'lote',
        'number' => 'número do lote',
        'closed_at' => 'fechado em',

        //Doctor
        'doctor_id' => 'profissional',
        'cp' => 'conselho profissional',
        'advice_number' => 'número no conselho',
        'uf' => 'uf',
        'cbo' => 'código CBO',

        //Guide
        'provider_number' => 'nº da guia no prestador',
        'main_number' => 'nº da guia principal',
        'permission_date' => 'data da autorização',
        'password_expiration' => 'validade da senha',
        'guide_operator_number' => 'nº da guia atribuído pela operadora',
        'rn' => 'atendimento a RN',
        'character_treatment' => 'caráter do atendimento',
        'request_date' => 'data da solicitação',
        'clinical_indication' => 'indicação clínica',
        'type_treatment' => 'tipo do atendimento',
        'accident_indication' => 'indicação de acidente',
        'total' => 'total geral',
